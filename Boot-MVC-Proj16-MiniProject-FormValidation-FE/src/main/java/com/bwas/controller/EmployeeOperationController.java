...
import com.bwas.validation.EmployeeValidation;
...
public class EmployeeOperationController {
	...
	public String showEmployeeReport(Map<String, Object> map) {
		...
		Iterable<Employee> itEmps = service.getAllEmployees();
	...
	public String EmployeeRegister(@ModelAttribute("emp") Employee emp, RedirectAttributes attr,
			BindingResult error) {
		/*
		 * if(validation.supports(Employee.class)) { validation.validate(emp, error);
		 * if(error.hasErrors()) { return "register_employee"; } }
		 */
	...
	@PostMapping("/emp_edit")
	 public String showEmplueeUpdatedData(@ModelAttribute("emp") Employee emp,RedirectAttributes attr,
			 BindingResult error) {
			/*
			 * if(validation.supports(Employee.class)) { validation.validate(emp, error);
			 * if(error.hasErrors()) { return "register_employee"; } }
